...
class TestTemplates:
    ...
    def test_raw_response_create(self, client: PostGrid) -> None:
        response = client.print_mail.templates.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: PostGrid) -> None:
        with client.print_mail.templates.with_streaming_response.create() as response:
    ...
    def test_raw_response_retrieve(self, client: PostGrid) -> None:
        response = client.print_mail.templates.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: PostGrid) -> None:
        with client.print_mail.templates.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.print_mail.templates.with_raw_response.retrieve(
                "",
            )
    ...
    def test_raw_response_update(self, client: PostGrid) -> None:
        response = client.print_mail.templates.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: PostGrid) -> None:
        with client.print_mail.templates.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.print_mail.templates.with_raw_response.update(
                id="",
            )
    ...
    def test_method_list(self, client: PostGrid) -> None:
        template = client.print_mail.templates.list()
        assert_matches_type(SyncSkipLimit[Template], template, path=["response"])
    ...
    def test_raw_response_list(self, client: PostGrid) -> None:
        response = client.print_mail.templates.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: PostGrid) -> None:
        with client.print_mail.templates.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_delete(self, client: PostGrid) -> None:
        response = client.print_mail.templates.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: PostGrid) -> None:
        with client.print_mail.templates.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.print_mail.templates.with_raw_response.delete(
                "",
            )
...
class TestAsyncTemplates:
    ...
    async def test_method_create(self, async_client: AsyncPostGrid) -> None:
        template = await async_client.print_mail.templates.create()
        assert_matches_type(Template, template, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.print_mail.templates.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncPostGrid) -> None:
        async with async_client.print_mail.templates.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncPostGrid) -> None:
        template = await async_client.print_mail.templates.retrieve(
            "id",
        )
        assert_matches_type(Template, template, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.print_mail.templates.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPostGrid) -> None:
        async with async_client.print_mail.templates.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.print_mail.templates.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncPostGrid) -> None:
        template = await async_client.print_mail.templates.update(
            id="id",
        )
        assert_matches_type(Template, template, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.print_mail.templates.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPostGrid) -> None:
        async with async_client.print_mail.templates.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.print_mail.templates.with_raw_response.update(
                id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncPostGrid) -> None:
        template = await async_client.print_mail.templates.list()
        assert_matches_type(AsyncSkipLimit[Template], template, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.print_mail.templates.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncPostGrid) -> None:
        async with async_client.print_mail.templates.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncPostGrid) -> None:
        template = await async_client.print_mail.templates.delete(
            "id",
        )
        assert_matches_type(TemplateDeleteResponse, template, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.print_mail.templates.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncPostGrid) -> None:
        async with async_client.print_mail.templates.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.print_mail.templates.with_raw_response.delete(
                "",
            )
