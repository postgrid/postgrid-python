...
from postgrid.types import Postcard, PostcardURLResponse
...
class TestPostcards:
    ...
    def test_raw_response_create_overload_1(self, client: PostGrid) -> None:
        response = client.postcards.with_raw_response.create(
            back_html="backHTML",
            front_html="frontHTML",
            size="6x4",
            to={
    ...
    def test_streaming_response_create_overload_1(self, client: PostGrid) -> None:
        with client.postcards.with_streaming_response.create(
            back_html="backHTML",
            front_html="frontHTML",
            size="6x4",
            to={
    ...
    def test_method_retrieve(self, client: PostGrid) -> None:
        postcard = client.postcards.retrieve(
            "id",
        )
        assert_matches_type(Postcard, postcard, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: PostGrid) -> None:
        response = client.postcards.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: PostGrid) -> None:
        with client.postcards.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.postcards.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: PostGrid) -> None:
        postcard = client.postcards.list()
        assert_matches_type(SyncList[Postcard], postcard, path=["response"])
    ...
    def test_raw_response_list(self, client: PostGrid) -> None:
        response = client.postcards.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: PostGrid) -> None:
        with client.postcards.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: PostGrid) -> None:
        postcard = client.postcards.delete(
            "id",
        )
        assert_matches_type(Postcard, postcard, path=["response"])
    ...
    def test_raw_response_delete(self, client: PostGrid) -> None:
        response = client.postcards.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: PostGrid) -> None:
        with client.postcards.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.postcards.with_raw_response.delete(
                "",
            )

    @parametrize
    def test_method_url(self, client: PostGrid) -> None:
        postcard = client.postcards.url(
            "id",
        )
        assert_matches_type(PostcardURLResponse, postcard, path=["response"])

    @parametrize
    def test_raw_response_url(self, client: PostGrid) -> None:
        response = client.postcards.with_raw_response.url(
            "id",
        )
    ...
    @parametrize
    def test_streaming_response_url(self, client: PostGrid) -> None:
        with client.postcards.with_streaming_response.url(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_url(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.postcards.with_raw_response.url(
                "",
            )
...
class TestAsyncPostcards:
    ...
    async def test_method_create_overload_1(self, async_client: AsyncPostGrid) -> None:
        postcard = await async_client.postcards.create(
            back_html="backHTML",
            front_html="frontHTML",
            size="6x4",
            to={
    ...
    async def test_raw_response_create_overload_1(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.postcards.with_raw_response.create(
            back_html="backHTML",
            front_html="frontHTML",
            size="6x4",
            to={
    ...
    async def test_streaming_response_create_overload_1(self, async_client: AsyncPostGrid) -> None:
        async with async_client.postcards.with_streaming_response.create(
            back_html="backHTML",
            front_html="frontHTML",
            size="6x4",
            to={
    ...
    async def test_method_retrieve(self, async_client: AsyncPostGrid) -> None:
        postcard = await async_client.postcards.retrieve(
            "id",
        )
        assert_matches_type(Postcard, postcard, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.postcards.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPostGrid) -> None:
        async with async_client.postcards.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.postcards.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncPostGrid) -> None:
        postcard = await async_client.postcards.list()
        assert_matches_type(AsyncList[Postcard], postcard, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.postcards.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncPostGrid) -> None:
        async with async_client.postcards.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncPostGrid) -> None:
        postcard = await async_client.postcards.delete(
            "id",
        )
        assert_matches_type(Postcard, postcard, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.postcards.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncPostGrid) -> None:
        async with async_client.postcards.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.postcards.with_raw_response.delete(
                "",
            )

    @parametrize
    async def test_method_url(self, async_client: AsyncPostGrid) -> None:
        postcard = await async_client.postcards.url(
            "id",
        )
        assert_matches_type(PostcardURLResponse, postcard, path=["response"])

    @parametrize
    async def test_raw_response_url(self, async_client: AsyncPostGrid) -> None:
        response = await async_client.postcards.with_raw_response.url(
            "id",
        )
    ...
    @parametrize
    async def test_streaming_response_url(self, async_client: AsyncPostGrid) -> None:
        async with async_client.postcards.with_streaming_response.url(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_url(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.postcards.with_raw_response.url(
                "",
            )
