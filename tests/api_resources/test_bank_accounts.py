...
from postgrid.types import BankAccount, BankAccountDeleteResponse
...
class TestBankAccounts:
    ...
    def test_path_params_retrieve(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.bank_accounts.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_list(self, client: PostGrid) -> None:
        ...
        assert_matches_type(SyncList[BankAccount], bank_account, path=["response"])
    ...
    def test_path_params_delete(self, client: PostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.bank_accounts.with_raw_response.delete(
                "",
            )
...
class TestAsyncBankAccounts:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.bank_accounts.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncPostGrid) -> None:
        ...
        assert_matches_type(AsyncList[BankAccount], bank_account, path=["response"])
    ...
    async def test_path_params_delete(self, async_client: AsyncPostGrid) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.bank_accounts.with_raw_response.delete(
                "",
            )
