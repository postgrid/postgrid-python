...
from postgrid._utils import asyncify
from postgrid._models import BaseModel, FinalRequestOptions
from postgrid._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
...
class TestPostGrid:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    def test_copy(self, client: PostGrid) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

        copied = client.copy(address_verification_api_key="another My Address Verification API Key")
        assert copied.address_verification_api_key == "another My Address Verification API Key"
        assert client.address_verification_api_key == "My Address Verification API Key"

        copied = client.copy(print_mail_api_key="another My Print Mail API Key")
        assert copied.print_mail_api_key == "another My Print Mail API Key"
        assert client.print_mail_api_key == "My Print Mail API Key"

    def test_copy_default_options(self, client: PostGrid) -> None:
    ...
    def test_copy_signature(self, client: PostGrid) -> None:
    ...
    def test_copy_build_request(self, client: PostGrid) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "postgrid/_legacy_response.py",
                        "postgrid/_response.py",
    ...
    def test_request_timeout(self, client: PostGrid) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_validate_headers(self) -> None:
        ...
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("X-API-Key") == address_verification_api_key
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("X-API-Key") == print_mail_api_key

        with update_env(
            **{
                "POSTGRID_ADDRESS_VERIFICATION_API_KEY": Omit(),
                "POSTGRID_PRINT_MAIL_API_KEY": Omit(),
            }
        ):
            client2 = PostGrid(
                base_url=base_url,
                address_verification_api_key=None,
                print_mail_api_key=None,
                _strict_response_validation=True,
            )

        with pytest.raises(
            TypeError,
            match="Could not resolve authentication method. Expected either address_verification_api_key or print_mail_api_key to be set. Or for one of the `X-API-Key` or `X-API-Key` headers to be explicitly omitted",
        ):
    ...
    def test_hardcoded_query_params_in_url(self, client: PostGrid) -> None:
    ...
    def test_request_extra_json(self, client: PostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: PostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: PostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: PostGrid) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, client: PostGrid) -> None:
        """
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: PostGrid) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: PostGrid
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: PostGrid) -> None:
        respx_mock.post("/v1/addver/verifications").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.address_verification.with_streaming_response.verify(address="address").__enter__()

        assert _get_open_connections(client) == 0

    @mock.patch("postgrid._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: PostGrid) -> None:
        respx_mock.post("/v1/addver/verifications").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/addver/verifications").mock(side_effect=retry_handler)

        response = client.address_verification.with_raw_response.verify(address="address")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.address_verification.with_raw_response.verify(
            address="address", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.address_verification.with_raw_response.verify(
            address="address", extra_headers={"x-stainless-retry-count": "42"}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: PostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: PostGrid) -> None:
...
class TestAsyncPostGrid:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncPostGrid) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

        copied = async_client.copy(address_verification_api_key="another My Address Verification API Key")
        assert copied.address_verification_api_key == "another My Address Verification API Key"
        assert async_client.address_verification_api_key == "My Address Verification API Key"

        copied = async_client.copy(print_mail_api_key="another My Print Mail API Key")
        assert copied.print_mail_api_key == "another My Print Mail API Key"
        assert async_client.print_mail_api_key == "My Print Mail API Key"

    def test_copy_default_options(self, async_client: AsyncPostGrid) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncPostGrid) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncPostGrid) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncPostGrid) -> None:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncPostGrid) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, async_client: AsyncPostGrid
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        class Model1(BaseModel):
            name: str
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_union_response_different_types(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        """Union of objects with the same field name using a different type"""
    ...
    async def test_base_url_trailing_slash(self, client: AsyncPostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncPostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncPostGrid) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_client_response_validation_error(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        class Model(BaseModel):
            foo: str
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = AsyncPostGrid(
            base_url=base_url,
            address_verification_api_key=address_verification_api_key,
            print_mail_api_key=print_mail_api_key,
            _strict_response_validation=False,
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncPostGrid
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.address_verification.with_streaming_response.verify(address="address").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.address_verification.with_raw_response.verify(address="address")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.address_verification.with_raw_response.verify(
            address="address", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncPostGrid) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
