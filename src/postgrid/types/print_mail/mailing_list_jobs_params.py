...
class MailingListJobsParams(TypedDict, total=False):
    add_contacts: Annotated[List[str], PropertyInfo(alias="addContacts")]
    """List of contact IDs to add to the mailing list.

    Cannot be used with other operations.
    """

    add_mailing_list_imports: Annotated[List[str], PropertyInfo(alias="addMailingListImports")]
    """List of mailing list import IDs to add to the mailing list.

    Cannot be used with other operations.
    """

    remove_contacts: Annotated[List[str], PropertyInfo(alias="removeContacts")]
    """List of contact IDs to remove from the mailing list.

    Cannot be used with other operations.
    """

    remove_mailing_list_imports: Annotated[List[str], PropertyInfo(alias="removeMailingListImports")]
