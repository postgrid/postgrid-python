...
from ..types import postcard_list_params, postcard_create_params
from .._types import (
    NOT_GIVEN,
    Body,
    Query,
...
from ..types.postcard import Postcard
from ..types.postcard_url_response import PostcardURLResponse
...
class PostcardsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        size: Literal["6x4", "9x6", "11x6"] | NotGiven = NOT_GIVEN,
...
class AsyncPostcardsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Postcard, AsyncList[Postcard]]:
        """
        Get a list of postcards.
