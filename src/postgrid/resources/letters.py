...
from ..types import letter_list_params, letter_create_params
...
from ..types.letter import Letter
from ..types.letter_url_response import LetterURLResponse
...
class LettersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        address_placement: Literal["top_first_page", "insert_blank_page"] | NotGiven = NOT_GIVEN,
        attached_pdf: letter_create_params.LetterCreateWithHTMLAttachedPdf | NotGiven = NOT_GIVEN,
        ...
        plastic_card: letter_create_params.LetterCreateWithHTMLPlasticCard | NotGiven = NOT_GIVEN,
        return_envelope: str | NotGiven = NOT_GIVEN,
        send_date: Union[str, datetime] | NotGiven = NOT_GIVEN,
        size: Literal["us_letter", "a4"] | NotGiven = NOT_GIVEN,
    ...
    def create(
        ...
        *,
        ...
        address_placement: Literal["top_first_page", "insert_blank_page"] | NotGiven = NOT_GIVEN,
        attached_pdf: letter_create_params.LetterCreateWithPdfAttachedPdf | NotGiven = NOT_GIVEN,
        color: bool | NotGiven = NOT_GIVEN,
        description: str | NotGiven = NOT_GIVEN,
        double_sided: bool | NotGiven = NOT_GIVEN,
        envelope: str | NotGiven = NOT_GIVEN,
        ...
        metadata: Dict[str, object] | NotGiven = NOT_GIVEN,
        perforated_page: Literal[1] | NotGiven = NOT_GIVEN,
        plastic_card: letter_create_params.LetterCreateWithPdfPlasticCard | NotGiven = NOT_GIVEN,
        return_envelope: str | NotGiven = NOT_GIVEN,
        send_date: Union[str, datetime] | NotGiven = NOT_GIVEN,
        size: Literal["us_letter", "a4"] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class AsyncLettersResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Letter, AsyncList[Letter]]:
        """
        Get a list of letters.
