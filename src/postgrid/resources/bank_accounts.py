...
from ..types import bank_account_list_params, bank_account_create_params
from .._types import (
    NOT_GIVEN,
    Body,
    Query,
...
from ..types.bank_account_delete_response import BankAccountDeleteResponse
...
class BankAccountsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        account_number: str,
        bank_country_code: Literal["CA", "US"],
        bank_name: str,
        signature_text: str,
...
class AsyncBankAccountsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[BankAccount, AsyncList[BankAccount]]:
        """
        Get a list of bank accounts.
